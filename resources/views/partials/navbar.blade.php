    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <ul class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
                    <li class="border-transparent inline-flex items-center px-1 pt-1 border-b-2"><a href="#" class="text-gray-500 hover:text-gray-700 text-sm font-medium">Assurance RC</a></li>
                    <li class="border-indigo-500 inline-flex items-center px-1 pt-1 border-b-2"><a href="#" class="text-gray-900 text-sm font-medium">Assurance RC Pro</a></li>
                    <li class="border-transparent inline-flex items-center px-1 pt-1 border-b-2"><a href="#" class="text-gray-500 hover:text-gray-700 text-sm font-medium">Contact</a></li>
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                <div class="ml-3 relative">
                    ...
                    <div class="origin-top-right hidden absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
